...
def Evaluate(individual,eNum):
	rVal = 0
	if eNum <= 1:
		rVal = EvaluateF1(individual)
	elif eNum == 2:
		rVal = EvaluateF2(individual)
	elif eNum == 3:
		rVal = EvaluateF3(individual)
	elif eNum == 4:
		rVal = EvaluateF4(individual)
	else:
		rVal = EvaluateF5(individual)
	return rVal
